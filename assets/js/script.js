...
function displayCard() {
    ...
    queryValue = stateSelect.options[stateSelect.selectedIndex].value.length === 0 && localStorage.getItem("state") ? localStorage.getItem("state"):stateSelect.options[stateSelect.selectedIndex].value
...
window.onload = function () {
    var state = stateSelect.options[stateSelect.selectedIndex].value.length === 0 && localStorage.getItem("state") ? localStorage.getItem("state"):stateSelect.options[stateSelect.selectedIndex].value
